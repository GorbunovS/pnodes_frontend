...
export const envPresets = {
  sceneType: [
    ...
    { id: "nature_forest_morning", label: "Лес утром (рассеянный туман)" },
  ...
  backgroundMood: [
    ...
    { id: "hazy_atmospheric", label: "Легкая дымка / атмосфера" },
  ...
  cameraFraming: [
    ...
    { id: "off_center_rule_of_thirds", label: "Смещение по правилу третей" },
    { id: "dynamic_angle_low_high", label: "Динамичный ракурс (снизу/сверху)" },
  ]
