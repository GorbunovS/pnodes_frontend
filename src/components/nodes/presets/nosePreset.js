...
export const nosePresets = {
  type: [
    ...
    { id: "roman_prominent", label: "Римский (крупный, выступающий)" },
    { id: "snub_small", label: "Вздернутый (короткий)" },
    { id: "bulbous_fleshy", label: "Мясистый (округлый)" },
    { id: "nubian_wide", label: "Нубийский (широкий, плоский)" },
  ...
  bridge: [
    ...
    { id: "concave_slope", label: "Вогнутый профиль" },
  ...
  tip: [
    ...
    { id: "slightly_upturned", label: "Слегка приподнятый" },
    { id: "downturned", label: "Опущенный вниз" },
  ],
};
