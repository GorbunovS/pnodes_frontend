export const eyePresets = {
  shape: [
    ...
    { id: "upturned_cat", label: "Приподнятые уголки (Cat eyes)" },
    { id: "downturned_sad", label: "Опущенные уголки (Sad eyes)" },
    { id: "hooded_intense", label: "Нависшее веко / Глубокие" },
  ...
  color: [
    ...
    { id: "emerald_green", label: "Изумрудно-зелёные" },
    { id: "ice_blue", label: "Ледяные голубые" },
    { id: "navy_blue", label: "Тёмно-синие" },
    { id: "grey_stormy", label: "Серые / Стальные" },
